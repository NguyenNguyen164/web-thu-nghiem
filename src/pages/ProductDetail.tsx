...
import {
  ...
  VStack, Divider, Tabs, TabList, TabPanels, Tab, TabPanel, useDisclosure,
  Modal, ModalOverlay, ModalContent, ModalHeader, ModalBody, ModalCloseButton,
  List, ListItem, ListIcon, Tooltip, Wrap, WrapItem, AspectRatio
} from '@chakra-ui/react';
import { 
  FiArrowLeft, FiShoppingCart, FiHeart, FiShare2, FiArrowUp, 
  FiCheck, FiTruck, FiShield, FiCreditCard, FiTag, FiLayers, 
  FiTruck as FiTruckIcon, FiRefreshCw, FiCheckCircle, FiInfo
} from 'react-icons/fi';
